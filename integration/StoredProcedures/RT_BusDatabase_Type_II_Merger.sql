...
begin
    ...
    from (
        ...
        when not matched then
            ...
            values
            (
                SRC.Id, SRC.InternalNumber, SRC.RegistrationNumber, ChassisNumber, ChassisSupplier, BodySupplier
               ,BusModel, BusType, FloorType, Contractor, SubContractor, SpecialEquipment, Aircon, DesignPainting
               ,NumberOfSeats, NumberOfFoldingSeats, NumberOfPitches, ApprovedTotalCapacity, DoorConfiguration
               ,NumberOfBabyCarriages, Length, Width, Height, ShaftDistance, OwnWeight, TotalWeight, EmissionNorm, Fuel
               ,EmissionsEquipment, NOx, Hc, Co, Pm, DieselConsumptionSORT1, DieselConsumptionSORT2
               ,DieselConsumptionSORT3, CO2PerKMSORT1, CO2PerKMSORT2, CO2PerKMSORT3, Efficiency, NoiseInside2008
               ,NoiseOutside2008, NoiseInside2017, NoiseOutside2017, Garage, Procurement, ContractUnit, Infotainment
               ,Lines, ReserveBus, FirstRegistrationDate, FirstCommissioningDate, InUse, Obs, InfotainmentSupplier
               ,OperatingTermination, Flowtype, CountBus, NewRealTime, SupplierRealTime, LastModified, GarageRef
               ,GarageAddress, ContractorRef, @Today, 1
            )
