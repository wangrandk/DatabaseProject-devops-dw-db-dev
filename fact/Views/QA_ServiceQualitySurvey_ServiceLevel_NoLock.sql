...
from
    ...
    join DW_EDW.integration.QA_ServiceQualitySurvey_MeasuringPeriodContractBridge as mpcb on
        mpcb.ContractCode = c.ContractCode
    join DW_EDW.dim.QA_ServiceQualitySurvey_MeasuringPeriod as d on
