...
CREATE NONCLUSTERED INDEX [IX_RT_ROI_Departure_IsOnDatedVehicleJourneyId]
    ...
    INCLUDE([OperatingDayDate], [TimetabledEarliestDateTime], [TargetDateTime], [EstimatedDateTime], [ObservedDateTime], [JourneyPatternSequenceNumber], [IsTargetedAtJourneyPatternPointGid], [State], [Type]) WITH (FILLFACTOR = 100);
