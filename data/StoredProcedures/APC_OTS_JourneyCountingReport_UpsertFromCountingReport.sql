...
-- =============================================
create procedure [data].[APC_OTS_JourneyCountingReport_UpsertFromCountingReport]
(
...
begin
    ...
    truncate table [stg].[APC_OTS_JourneyCountingReport];
    ...
    insert into
        [stg].[APC_OTS_JourneyCountingReport]
    (
    ...
    from
        ...
        left join [data].[APC_OTS_DailyVehicleBalance] dvb1 on
            dvb1.[Date] = apc.[MinDate]
            and dvb1.[VehicleRef] = apc.[VehicleRef]
        left join [data].[APC_OTS_DailyVehicleBalance] dvb2 on
    ...
    exec [integration].[AutoMerge]
        @Source = N'[stg].[APC_OTS_JourneyCountingReport]'
       ,@Target = N'[data].[APC_OTS_JourneyCountingReport]'
       ,@Mode = 1;
    ...
    t
    from
        [data].[APC_OTS_JourneyCountingReport] t
        left join [stg].[APC_OTS_JourneyCountingReport] s on
