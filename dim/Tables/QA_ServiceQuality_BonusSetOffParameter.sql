CREATE TABLE [dim].[QA_ServiceQuality_BonusSetOffParameter] (
    ...
    CONSTRAINT [PK_QA_ServiceQuality_BonusSetOffParameter] PRIMARY KEY CLUSTERED ([BonusSetOffParametersKey] ASC)
);
