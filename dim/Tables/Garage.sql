CREATE TABLE [dim].[Garage] (
    ...
    CONSTRAINT [BK_Garage] UNIQUE NONCLUSTERED ([GarageCode] ASC, [ValidFromDateKey] ASC) WITH (FILLFACTOR = 100),
    CONSTRAINT [UQ_Garage_SourceSystemCode_SourceSystemEntryId] UNIQUE NONCLUSTERED ([SourceSystemCode] ASC, [SourceSystemEntryId] ASC) WITH (FILLFACTOR = 100)
);
