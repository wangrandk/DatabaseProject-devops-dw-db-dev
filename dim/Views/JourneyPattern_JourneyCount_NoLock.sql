...
CREATE view [dim].[JourneyPattern_JourneyCount_NoLock] as 
	...
	from [DW_EDW].[data].[RT_Journey] (nolock)
	where 
	...
	from [DW_EDW].[dim].[JourneyPattern] (nolock) as jp 
	left outer join  [DW_EDW].[dim].[Line_Nyt_Bynet] as d on jp.LineNumber = d.LineNumber
