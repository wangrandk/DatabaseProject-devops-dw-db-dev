...
CREATE UNIQUE NONCLUSTERED INDEX [BK_QA_ServiceQuality_ServiceLevel]
    ON [stg_fact].[QA_ServiceQuality_ServiceLevel]([JourneyRef] ASC)
...
CREATE NONCLUSTERED INDEX [UQ_QA_ServiceQuality_ServiceLevel_Merge]
    ON [stg_fact].[QA_ServiceQuality_ServiceLevel]([OperatingDayDate] ASC)
